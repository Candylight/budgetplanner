 ...
 */
class Version20180429123437 extends AbstractMigration
{
    public function up(Schema $schema)
    {
        ...
        $this->addSql('CREATE TABLE budget_budget_category (budget_id INT NOT NULL, budget_category_id INT NOT NULL, INDEX IDX_75739A6036ABA6B8 (budget_id), INDEX IDX_75739A60644CDBBD (budget_category_id), PRIMARY KEY(budget_id, budget_category_id)) DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_unicode_ci ENGINE = InnoDB');
        ...
        $this->addSql('ALTER TABLE budget_budget_category ADD CONSTRAINT FK_75739A6036ABA6B8 FOREIGN KEY (budget_id) REFERENCES budget (id) ON DELETE CASCADE');
        $this->addSql('ALTER TABLE budget_budget_category ADD CONSTRAINT FK_75739A60644CDBBD FOREIGN KEY (budget_category_id) REFERENCES budget_category (id) ON DELETE CASCADE');
    ...
    public function down(Schema $schema)
    {
        ...
        $this->addSql('ALTER TABLE budget_budget_category DROP FOREIGN KEY FK_75739A6036ABA6B8');
        $this->addSql('ALTER TABLE budget_budget_category DROP FOREIGN KEY FK_75739A60644CDBBD');
        ...
        $this->addSql('DROP TABLE budget_budget_category');
