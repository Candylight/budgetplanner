...
import {
  GOAL_UPDATE_RESET,
  GOAL_UPDATE_UPDATE_ERROR,
  GOAL_UPDATE_UPDATE_LOADING,
  GOAL_UPDATE_UPDATE_SUCCESS,
  GOAL_UPDATE_RETRIEVE_ERROR,
  GOAL_UPDATE_RETRIEVE_LOADING,
  GOAL_UPDATE_RETRIEVE_SUCCESS,
  GOAL_UPDATE_UPDATE_VIOLATIONS
} from './mutation-types';
...
function retrieveError(retrieveError) {
  return {type: GOAL_UPDATE_RETRIEVE_ERROR, retrieveError};
}

function retrieveLoading(retrieveLoading) {
  return {type: GOAL_UPDATE_RETRIEVE_LOADING, retrieveLoading};
}

function retrieveSuccess(retrieved) {
  return {type: GOAL_UPDATE_RETRIEVE_SUCCESS, retrieved};
}

function updateError(updateError) {
  return {type: GOAL_UPDATE_UPDATE_ERROR, updateError};
}

function updateLoading(updateLoading) {
  return {type: GOAL_UPDATE_UPDATE_LOADING, updateLoading};
}

function updateSuccess(updated) {
  return {type: GOAL_UPDATE_UPDATE_SUCCESS, updated};
}

function violations(violations) {
  return {type: GOAL_UPDATE_UPDATE_VIOLATIONS, violations};
}

function reset() {
  return {type: GOAL_UPDATE_RESET};
}
...
const mutations = {
    [GOAL_UPDATE_RETRIEVE_ERROR] (state, payload) {
      state.retrieveError = payload.retrieveError;
    },
    [GOAL_UPDATE_RETRIEVE_LOADING] (state, payload) {
      state.retrieveLoading = payload.retrieveLoading;
    },
    [GOAL_UPDATE_RETRIEVE_SUCCESS] (state, payload) {
      state.retrieved = payload.retrieved;
    },
    [GOAL_UPDATE_UPDATE_LOADING] (state, payload) {
      state.updateLoading = payload.loading;
    },
    [GOAL_UPDATE_UPDATE_ERROR] (state, payload) {
      state.updateError = payload.updateError;
    },
    [GOAL_UPDATE_UPDATE_SUCCESS] (state, payload) {
      state.updated = payload.updated;
      state.violations = null;
    },
    [GOAL_UPDATE_UPDATE_VIOLATIONS] (state, payload) {
      state.violations = payload.violations;
    },
    [GOAL_UPDATE_RESET] (state) {
      state.loading = false;
      state.retrieveError = '';
